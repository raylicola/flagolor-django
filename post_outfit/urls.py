...
urlpatterns = [
    ...
    path('update_good/<str:username>/<int:outfit_id>/', views.update_good, name='update_good'),
    path('update_save/<str:username>/<int:outfit_id>/', views.update_save, name='update_save'),
